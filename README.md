...
3. Applied Excel financial functions for calculations
4. Interpreted results to derive financial insights
5. Summarized findings in a presentation format

## Scope and Objectives
- Perform financial analysis using Excel
- Evaluate investments using PV, NPV, IRR, and MIRR
- Analyze irregular cash flows using XNPV and XIRR
- Understand loan repayment using EMI calculations
...
- `Financial_Analysis_Project_Presentation.pptx` – Concept explanation and results
